...
class Data(models.Model):
    ...
    victim_children = models.CharField(max_length=64, blank=True, null=True)
    victim_religion = models.IntegerField(blank=True, null=True)
    ...
    securityforces_idknown = models.IntegerField()
