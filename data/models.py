...
class Data(models.Model):
    ...
    securityforces_idknown_1 = models.IntegerField(db_column='securityforces_idknown__1')
    securityforces_idknown_2 = models.IntegerField(db_column='securityforces_idknown__2')
    securityforces_idknown_3 = models.IntegerField(db_column='securityforces_idknown__3')
