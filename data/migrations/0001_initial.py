# Generated by Django 2.2.10 on 2021-06-04 17:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('victim_name_pb', models.CharField(blank=True, max_length=256, null=True)),
                ('village_name', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('victim_alias_name', models.CharField(blank=True, max_length=256, null=True)),
                ('village_id', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ('district_id', models.CharField(blank=True, max_length=8, null=True)),
                ('record_id', models.CharField(db_column='record_id', max_length=8, primary_key=True, serialize=False)),
                ('urban_rural', models.IntegerField(blank=True, db_column='urban_rural', null=True)),
                ('timeline', models.DateField(blank=True, db_column='timeline', null=True)),
                ('timeline_start', models.DateField(blank=True, db_column='timeline_start', null=True)),
                ('timeline_end', models.DateField(blank=True, db_column='timeline_end', null=True)),
                ('arrest_start', models.DateField(blank=True, db_column='arrest_start', null=True)),
                ('arrest_end', models.DateField(blank=True, db_column='arrest_end', null=True)),
                ('othervill_interview', models.CharField(blank=True, max_length=256, null=True)),
                ('publish_information', models.IntegerField(blank=True, null=True)),
                ('publish_restriction', models.IntegerField(blank=True, null=True)),
                ('publish_restriction_other', models.CharField(blank=True, max_length=64, null=True)),
                ...
                ('victim_first_name', models.CharField(blank=True, max_length=256, null=True)),
                ('victim_first_name_pb', models.CharField(blank=True, max_length=256, null=True)),
                ('victim_sex', models.IntegerField(blank=True, null=True)),
                ('victim_age', models.CharField(max_length=64)),
                ('victim_age_averaged', models.IntegerField(blank=True, db_column='victim_age_averaged', null=True)),
                ('victim_address_int_loc', models.IntegerField(blank=True, null=True)),
                ('victim_address_other', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('victim_employment_other', models.CharField(blank=True, max_length=256, null=True)),
                ('victim_marital_status', models.IntegerField(blank=True, null=True)),
                ('victim_children', models.CharField(blank=True, db_column='victim_children', max_length=64, null=True)),
                ('victim_religion', models.IntegerField(blank=True, db_column='victim_religion', null=True)),
                ...
                ('other_victim_caste', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('victim_prior_detentions', models.CharField(blank=True, max_length=64, null=True)),
                ...
                ('target_reason_other', models.CharField(blank=True, max_length=256, null=True)),
                ('victim_disappeared_killed', models.IntegerField(blank=True, null=True)),
                ('victim_death_date', models.CharField(blank=True, max_length=64, null=True)),
                ('victim_arrest_status', models.IntegerField(blank=True, null=True)),
                ('victim_arrest_date', models.CharField(blank=True, max_length=64, null=True)),
                ('victim_arrest_location', models.IntegerField(blank=True, null=True)),
                ('victim_arrest_loc_oth', models.CharField(blank=True, max_length=256, null=True)),
                ('victim_arrest_loc_vill', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('arrest_security_locality', models.IntegerField(blank=True, db_column='arrest_security_locality', null=True)),
                ...
                ('killing_securityforces_lcl', models.CharField(blank=True, max_length=256, null=True)),
                ('securityforces_idknown_1', models.IntegerField(blank=True, db_column='securityforces_idknown___1', default='NULL', null=True)),
                ('securityforces_idknown_2', models.IntegerField(blank=True, db_column='securityforces_idknown___2', default='NULL', null=True)),
                ('securityforces_idknown_3', models.IntegerField(blank=True, db_column='securityforces_idknown___3', default='NULL', null=True)),
                ...
                ('so_approached_loc', models.CharField(blank=True, max_length=237, null=True)),
                ...
                ('other_so_response', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('other_no_action_reason', models.CharField(blank=True, max_length=256, null=True)),
                ...
                ('oth_govnt_response_desired', models.CharField(blank=True, max_length=256, null=True)),
                ('photo_vic_fn', models.CharField(blank=True, max_length=256, null=True)),
                ('photo_doc_fn', models.CharField(blank=True, max_length=256, null=True)),
                ('photo_news_fn', models.CharField(blank=True, max_length=256, null=True)),
                ('photo_advocacy_fn', models.CharField(blank=True, max_length=256, null=True)),
                ('photo_personalpapers_fn', models.CharField(blank=True, max_length=256, null=True)),
                ('photo_family_fn', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family_reflections', models.TextField(blank=True, db_column='family_reflections', null=True)),
                ('video_url', models.CharField(blank=True, db_column='video_url', max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_arrested_first_name', models.CharField(blank=True, max_length=256, null=True)),
                ('other_arrested_last_name', models.CharField(blank=True, max_length=256, null=True)),
                ('other_arrested_village', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('others_killed_first_name', models.CharField(blank=True, max_length=256, null=True)),
                ('others_killed_last_name', models.CharField(blank=True, max_length=256, null=True)),
                ('others_killed_villtown', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_pb', models.CharField(blank=True, max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('arrest_so_first_name', models.CharField(blank=True, max_length=256, null=True)),
                ('arrest_so_last_name', models.CharField(blank=True, max_length=256, null=True)),
                ('arrest_so_rank', models.IntegerField(blank=True, null=True)),
                ('arrest_so_rank_other', models.CharField(blank=True, max_length=256, null=True)),
                ('arrest_so_affiliation', models.IntegerField(blank=True, null=True)),
                ('arrest_so_affiliation_oth', models.CharField(blank=True, max_length=256, null=True)),
                ('arrest_so_affiliation_loc', models.CharField(blank=True, max_length=256, null=True)),
                ('soa_code', models.CharField(blank=True, max_length=8, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('killing_so_first_name', models.CharField(blank=True, max_length=256, null=True)),
                ('killing_so_last_name', models.CharField(blank=True, max_length=256, null=True)),
                ('killing_so_rank', models.IntegerField(blank=True, null=True)),
                ('killing_so_rank_other', models.CharField(blank=True, max_length=256, null=True)),
                ('killing_so_affiliation', models.IntegerField(blank=True, null=True)),
                ('killing_so_affiliation_oth', models.CharField(blank=True, max_length=256, null=True)),
                ('killing_so_affiliation_loc', models.CharField(blank=True, max_length=256, null=True)),
                ('sok_code', models.CharField(blank=True, max_length=8, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='WhereVictimDetained',
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('detention_facility_type', models.IntegerField(blank=True, null=True)),
                ('detention_fac_type_oth', models.CharField(blank=True, max_length=144, null=True)),
                ('facility_name', models.CharField(blank=True, max_length=124, null=True)),
                ('facility_nearest_villtown', models.CharField(blank=True, max_length=54, null=True)),
                ('facility_tehsil', models.CharField(blank=True, max_length=17, null=True)),
                ('facility_district', models.CharField(blank=True, max_length=37, null=True)),
                ('duration_of_detention', models.CharField(blank=True, max_length=311, null=True)),
                ...
                ('witness_detention_other', models.CharField(blank=True, max_length=1024, null=True)),
                ('witness_report', models.CharField(blank=True, max_length=1024, null=True)),
                ('record_id', models.ForeignKey(blank=True, db_column='record_id', default='NULL', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='where_victim_detained', to='data.Data')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='villages',
            index=models.Index(fields=['vid'], name='villages_vid_f44aba_idx'),
        ),
        migrations.AddField(
            model_name='securitykilled',
            name='record_id',
            field=models.ForeignKey(blank=True, db_column='record_id', default='NULL', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='security_killed', to='data.Data'),
        ),
        migrations.AddField(
            model_name='securityarrest',
            name='record_id',
            field=models.ForeignKey(blank=True, db_column='record_id', default='NULL', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='security_arrest', to='data.Data'),
        ),
        migrations.AddField(
            model_name='otherskilled',
            name='record_id',
            field=models.ForeignKey(blank=True, db_column='record_id', default='NULL', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='others_killed', to='data.Data'),
        ),
        migrations.AddField(
            model_name='otherarrest',
            name='record_id',
            field=models.ForeignKey(blank=True, db_column='record_id', default='NULL', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='other_arrested', to='data.Data'),
        ),
        migrations.AddField(
            model_name='fullprofile',
            name='record_id',
            field=models.ForeignKey(blank=True, db_column='record_id', default='NULL', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='fullprofile', to='data.Data'),
        ),
        migrations.AddIndex(
            model_name='data',
            index=models.Index(fields=['village_id'], name='data_village_32d7c1_idx'),
        ),
        migrations.AddIndex(
            model_name='data',
            index=models.Index(fields=['village_name'], name='data_village_9e8a62_idx'),
        ),
    ]
